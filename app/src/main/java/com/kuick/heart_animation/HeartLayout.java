...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.live_like_icon);
    ...
    public void addFavor(int size) {
        ...
        if (lastTime == 0)
            time = 2 * 1000;//The first time is divided into 2 seconds to display
