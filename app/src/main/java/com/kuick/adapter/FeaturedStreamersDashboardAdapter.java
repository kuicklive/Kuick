...
public class FeaturedStreamersDashboardAdapter extends RecyclerView.Adapter<FeaturedStreamersDashboardAdapter.ViewHolder> {

    private final List<FeatureStreamers> featureStreamersList;
    public static String TAG = "FeaturedStreamersDashboardAdapter";


    private Context mContext;

    public FeaturedStreamersDashboardAdapter(List<FeatureStreamers> featureStreamers) {
    ...
    @NonNull
    @Override
    public FeaturedStreamersDashboardAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        this.mContext = parent.getContext();
        return new ViewHolder(TreandingStreamersItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull FeaturedStreamersDashboardAdapter.ViewHolder holder, int position) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        public TreandingStreamersItemBinding binding;
